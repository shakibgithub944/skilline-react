...
const UserInterface = () => {
  return (
    <div className="mt-40">
      <div
        data-aos="flip-down"
        className="text-center max-w-screen-md mx-auto mb-30"
      >
      ...
      <div className="md:flex md:space-x-10 items-start">
        ...
        <div
          data-aos="fade-down"
          className="md:w-5/12 mt-20 md:mt-0 text-[#696984]"
        >
          <h1 className="text-3xl font-semibold text-darken leading-10">
